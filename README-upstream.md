> **Preserved upstream README.** This is the original README of
> [Boriel ZX BASIC](https://github.com/boriel-basic/zxbasic) as it stood when
> this repository diverged — the Python toolchain in `src/` *is* that project,
> pinned as the byte-truth reference for the C port. Kept verbatim below for
> provenance and credit. For this repository's own README see
> [README.md](README.md); for the port story and meters see [PORTING.md](PORTING.md).
