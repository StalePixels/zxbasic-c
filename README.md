...
[![Codegen probes](https://img.shields.io/badge/probes-125_GREEN_0_RED-brightgreen)](#probe-enumeration-meter)
...
against the Python oracle. **125 probes GREEN, 0 RED** across 10
...
```
 ...
 Phase 3  ✅  BASIC Frontend — faithful PLY/LALR(1) port
    │         1033/1033 parse-only PASS, 0 false-positives, 125 probes GREEN
    │
