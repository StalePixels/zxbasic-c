...
[![Codegen probes](https://img.shields.io/badge/probes-96_GREEN-brightgreen)](#probe-enumeration-meter)
...
against the Python oracle. **96 probes GREEN, 0 RED** across 9
...
```
 ...
 Phase 3  ✅  BASIC Frontend — faithful PLY/LALR(1) port
    │         1016/1033 parse-only PASS, 0 false-positives, 96 probes GREEN
    │
