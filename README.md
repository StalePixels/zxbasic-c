...
[![Codegen probes](https://img.shields.io/badge/probes-97_GREEN-brightgreen)](#probe-enumeration-meter)
...
| 3 | **Compiler frontend (`zxbc`)** | **1018/1033** parse-only PASS / **0 false-positives** | ✅ Byte-identical except 3 known upstream Python bugs |
...
- ✅ **1018/1033 PASS** — C and Python produce byte-identical parse-only output
...
- 🔨 15 stderr-mismatch residuals — warning/error message text fidelity (binaries byte-identical; the diagnostic text still diverges on a small backlog)
...
against the Python oracle. **97 probes GREEN, 0 RED** across 9
...
```
 ...
 Phase 3  ✅  BASIC Frontend — faithful PLY/LALR(1) port
    │         1018/1033 parse-only PASS, 0 false-positives, 97 probes GREEN
    │
