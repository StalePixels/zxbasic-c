...
[![Codegen probes](https://img.shields.io/badge/probes-106_GREEN-brightgreen)](#probe-enumeration-meter)
...
| 3 | **Compiler frontend (`zxbc`)** | **1029/1033** parse-only PASS / **0 false-positives** | ✅ Byte-identical except 3 known upstream Python bugs |
...
- ✅ **1029/1033 PASS** — C and Python produce byte-identical parse-only output
...
- 🔨 4 stderr-mismatch residuals — warning/error message text fidelity (binaries byte-identical; the diagnostic text still diverges on a small backlog)
...
against the Python oracle. **106 probes GREEN, 0 RED** across 9
...
```
 ...
 Phase 3  ✅  BASIC Frontend — faithful PLY/LALR(1) port
    │         1029/1033 parse-only PASS, 0 false-positives, 106 probes GREEN
    │
