...
[![Codegen probes](https://img.shields.io/badge/probes-99_GREEN-brightgreen)](#probe-enumeration-meter)
...
| 3 | **Compiler frontend (`zxbc`)** | **1020/1033** parse-only PASS / **0 false-positives** | ✅ Byte-identical except 3 known upstream Python bugs |
...
- ✅ **1020/1033 PASS** — C and Python produce byte-identical parse-only output
...
against the Python oracle. **99 probes GREEN, 0 RED** across 9
...
```
 ...
 Phase 3  ✅  BASIC Frontend — faithful PLY/LALR(1) port
    │         1020/1033 parse-only PASS, 0 false-positives, 99 probes GREEN
    │
